    ...
    for (const {
      ...
      concertsByDate.push(
        ...
        >
          ...
          <h3 className="vertical-timeline-element-title" className={styles.artist}>
            {artist.name} {isCanceled && <h3>ANNULÉ</h3>}
          </h3>

          <h4 className="vertical-timeline-element-subtitle" className={styles.venue}>
